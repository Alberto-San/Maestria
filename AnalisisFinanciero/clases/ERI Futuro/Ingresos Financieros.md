...
$$Flujo de Caja Libre de la Compañía_{Supuesto(K=2025)}=Flujo de Caja Operación_{Supuesto(K=2025)} + Flujo de Caja Inversión{Supuesto(K=2025)}$$

$$Flujo de Caja Operación_{Supuesto(K=2025)} = Ebitda_{Supuesto(K=2025)} + Necesidades Netas de Capital de trabajo{Supuesto(K=2025)} - Impuesto de Renta{Supuesto(K=2025)}$$
$$Ebitda_{Supuesto(K=2025)}=Calculado$$
$$Necesidades Netas de Capital de trabajo{Supuesto(K=2025)}$$
